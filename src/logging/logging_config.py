...
from src.logging.color_formatter import ColoredFormatter


def setup_logging(default_path: str = 'src/logging/logging_config.json', default_level: int = logging.INFO) -> None:
    """
